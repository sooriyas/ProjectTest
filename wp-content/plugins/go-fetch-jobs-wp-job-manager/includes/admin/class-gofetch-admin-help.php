 ...
 */
class GoFetch_WPJM_Admin_Help extends BC_Framework_Admin_page {
	...
	public function setup() {
		...
		$this->args = array(
			...
			'page_slug'     => GoFetch_WPJM()->slug . '-help',
	...
	public function page_content() {
		...
		echo '<p><img style="width: 100%;" src="' . esc_url( GoFetch_WPJM()->plugin_url() . '/includes/admin/assets/images/guided-tutorial.png' ) . '"></p>';
		...
		echo '<p><img style="width: 100px;" src="' . esc_url( GoFetch_WPJM()->plugin_url() . '/includes/admin/assets/images/help-button.png' ) . '"></p>';
		...
		echo '<img style="max-width: 500px;" src="' . esc_url( GoFetch_WPJM()->plugin_url() . '/includes/admin/assets/images/tooltips.png' ) . '">';
	}
...
new GoFetch_WPJM_Admin_Help( GOFT_WPJM_PLUGIN_FILE, $goft_wpjm_options );
