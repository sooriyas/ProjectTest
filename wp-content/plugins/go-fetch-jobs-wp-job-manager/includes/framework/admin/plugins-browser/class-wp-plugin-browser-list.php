...
class BC_Framework_Plugin_Browser_List extends WP_List_Table {
	...
	protected function get_views() {
		...
		foreach ( (array) $this->tabs as $action => $text ) {
			...
			$display_tabs[ admin_url( "products-install-{$action}" ) ] = "<a href='" . esc_url( $href ) . "' class='" . esc_attr( $class ) . "'>" . $text['name'] . '</a>';
		}
		...
		<div class="plugin-card plugin-card-<?php echo sanitize_html_class( $plugin['slug'] ); ?>">
			...
			<div class="plugin-card-bottom">
				...
				<div class="column-requirements">
					<strong><?php echo __( 'Requirements:', 'wp-shp-browser' ); ?></strong> <span title="<?php echo __( 'Requirements', 'wp-shp-browser' ); ?>"><?php echo $plugin['requirements']; ?></span>
				</div>
				<div class="column-hosted">
					<a href="<?php echo esc_url( $plugin['host']['url'] ); ?>" class="thickbox" aria-label="<?php echo esc_attr( sprintf( __( 'Hosted by %s', 'wp-shp-browser'), $plugin['host']['name'] ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'Hosted by %s', 'wp-shp-browser'), $plugin['host']['name'] ) ); ?>">@ <?php echo $plugin['host']['name']; ?></a>
				</div>
			</div>
