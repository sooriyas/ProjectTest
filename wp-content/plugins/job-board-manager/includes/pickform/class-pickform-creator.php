...
*/
	...
	public function field_text($field_data){
			...
			if(isset($field_attributes['required'])){
				$required = 'required';
			...
			$html.= '<input id="'.$field_id.'" '.$required.' type="text" placeholder="'.$field_placeholder.'" name="'.$field_id.'" value="'.$field_values.'" />';			
	...
	public function field_text_multi($field_data){
            ...
            if(!empty($field_values)){
                if(is_array($field_values)){
                    ...
                    foreach($field_values as $key=>$value){
						...
						$html.= '<input class="remove-field" type="button" value="'.__('Remove',job_bm_textdomain).'" />';						
						$html.= '</div>';
            ...
            $html.= '</div>';
            $html.= '<input class="add-field" option-id="'.$field_id.'" type="button" value="'.__('Add more',job_bm_textdomain).'" />';			
            $html.= '</div>';			
	...
	public function field_date($field_data){
			...
			$html.= '<input id="'.$field_id.'" type="date" placeholder="'.$field_placeholder.'" name="'.$field_id.'" value="'.$field_values.'" />';	
	...
	public function field_datetime($field_data){
			...
			$html.= '<input id="'.$field_id.'" type="datetime" placeholder="'.$field_placeholder.'" name="'.$field_id.'" value="'.$field_values.'" />';	
	...
	public function field_email($field_data){
			...
			$html.= '<div class="title">'.$field_title.'</div>';				
			$html.= '<div class="details">'.$field_details.'</div>';
			$html.= '<input id="'.$field_id.'" type="email" placeholder="'.$field_placeholder.'" name="'.$field_id.'" value="'.$field_values.'" />';		
	...
	public function field_file($field_data){
			...
			$html.= '<p>'.__("Drop files here",job_bm_textdomain).'</p>
						<p class="drag-drop-buttons"><input id="plupload-browse-'.$field_id.'" type="button" value="'.__("Select Files",job_bm_textdomain).'" class="button" /></p>
					  </div>
					 </div>
				  </div>
  ...
  $plupload_init = array(
    ...
    'filters'             => array(array('title' => __('Allowed Files',job_bm_textdomain), 'extensions' => 'gif,png,jpg,jpeg')),
    'multipart'           => true,
  ...
  $plupload_init = apply_filters('plupload_init', $plupload_init);
	...
	public function field_number($field_data){
			...
			$html.= '<div class="title">'.$field_title.'</div>';				
			$html.= '<div class="details">'.$field_details.'</div>';
			$html.= '<input id="'.$field_id.'" type="number" placeholder="'.$field_placeholder.'" name="'.$field_id.'" value="'.$field_values.'" />';			
			return $html;
	...
	public function field_range($field_data){
			...
			$html.= '<div class="title">'.$field_title.'</div>';				
			$html.= '<div class="details">'.$field_details.'</div>';
			$html.= '<input id="'.$field_id.'" type="range" min="'.$min.'" max="'.$max.'" step="'.$step.'" name="'.$field_id.'" value="'.$field_values.'" />';			
	...
	public function field_textarea($field_data){
			...
			$html.= '<div class="title">'.$field_title.'</div>';				
			$html.= '<div class="details">'.$field_details.'</div>';
			$html.= '<textarea  id="'.$field_id.'" name="'.$field_id.'" placeholder="'.$field_placeholder.'"  >'.$field_values.'</textarea>';		
	...
	public function field_select_multi($field_data){
			...
			$html.= '<div class="title">'.$field_title.'</div>';				
			$html.= '<div class="details">'.$field_details.'</div>';
			$html.= '<select multiple="multiple" id="'.$field_id.'" name="'.$field_id.'[]" >';			
	...
	public function field_radio($field_data){
			...
			foreach($input_args as $input_args_key => $input_args_values){
				...
				$html.= '<label>';
				$html.= '<input '.$checked.' class="'.$field_id.'"  type="radio" name="'.$field_id.'" value="'.$input_args_key.'" />'.$input_args_values;
				$html.= '</label>';						
