...
class class_job_bm_functions{
	...
	public function job_type_list(){
		...
		$job_type_list = array('freelance'=>__('Freelance', 'job-board-manager'),'full-time'=>__('Full Time', 'job-board-manager'),'internship'=>__('Internship', 'job-board-manager'),'part-time'=>__('Part Time', 'job-board-manager'),'temporary'=>__('Temporary', 'job-board-manager'));
	...
	public function salary_type_list(){
		...
		$salary_type_list = array('negotiable'=>__('Negotiable', 'job-board-manager'),'fixed'=>__('Fixed', 'job-board-manager'),'min-max'=>__('Min-Max', 'job-board-manager'));
