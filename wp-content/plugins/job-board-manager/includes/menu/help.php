...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".__(sprintf('%s - Help',job_bm_plugin_name), 'job-board-manager')."</h2>";?>
    
    <div class="para-settings job-bm-admin">
    
   		<div class="option-box">
            <p class="option-title"><?php _e('Ask any question','job-board-manager'); ?></p>
            <p class="option-info">
            <?php _e('Please feel free to contact for any question, ask via our forum <a href="http://www.pickplugins.com/questions/">http://www.pickplugins.com/questions/</a>','job-board-manager'); ?>
            </p>
            
        </div>    
    
   		<div class="option-box">
            <p class="option-title"><?php _e('Watch video tutorial','job-board-manager'); ?></p>
   		...
   		<div class="option-box">
            <p class="option-title"><?php _e('FAQ','job-board-manager'); ?></p>
            <p class="option-info"></p>
