			...
			$section_options = array(
							...
							'job_bm_list_per_page'=>array(
								...
								'job_bm_list_archive_more_style'=>array(
									...
									'title'=>__('Archive load style','job-board-manager'),
									'option_details'=>__('Set load more style ajax or pagination','job-board-manager'),						
									'input_type'=>'select', // text, radio, checkbox, select, 
									'input_values'=>'pagination', // could be array
									'input_args'=> array( 'pagination'=>__('Pagination','job-board-manager'), 'ajax'=>__('Load more','job-board-manager'),),
...
*/
			...
			$options['<i class="fa fa-cogs"></i> '.__('Options','job-board-manager')] = apply_filters( 'job_bm_settings_section_options', $section_options );
			...
			$options['<i class="fa fa-file-powerpoint-o"></i> '.__('Pages','job-board-manager')] = apply_filters( 'job_bm_settings_section_pages', $section_options );
...
*/
								...
								'job_bm_can_user_edit_published_jobs'=>array(
									...
									'title'=>__('Can user edit jobs ?','job-board-manager'),
								...
								'job_bm_redirect_preview_link'=>array(
									...
									'title'=>__('Redirect preview link after job submit ?','job-board-manager'),
								...
								'job_bm_submission_type'=>array(
									...
									'title'=>__('Submission type ?','job-board-manager'),
									'option_details'=>__('Submission type.','job-board-manager'),						
									'input_type'=>'select', // text, radio, checkbox, select, 
									'input_values'=> 'yes', // could be array
									'input_args'=> array('step'=>__('Step by step','job-board-manager'),'accordion'=>__('Accordion','job-board-manager')),
									),										
			...
			$options['<i class="fa fa-suitcase"></i> '.__('Job Post','job-board-manager')] = apply_filters( 'job_bm_settings_section_job_post', $section_options );
			...
			$section_options = array(
								...
								'job_bm_notify_email_job_submit'=>array(
									...
									'title'=>__('Notify email new job submit ?','job-board-manager'),
			...
			$options['<i class="fa fa-bell-o"></i> '.__('Notification','job-board-manager')] = apply_filters( 'job_bm_settings_section_notification', $section_options );
			...
			$options['<i class="fa fa-diamond"></i> '.__('Style','job-board-manager')] = apply_filters( 'job_bm_settings_section_style', $section_options );
...
if(empty($_POST['job_bm_hidden']))
	...
	{	
		if($_POST['job_bm_hidden'] == 'Y') {
			...
			?>
			<div class="updated"><p><strong><?php _e('Changes Saved.', 'job-board-manager' ); ?></strong></p></div>
